...
<head>
  ...
  <title>REPORTE CAPITAL SOCIAL RESUMEN</title>
  <?php
...
<body>
    ...
    <tr>
      <td class="bold center">
        <h3 style="margin: 0;">REPORTE CAPITAL SOCIAL RESUMEN</h3>
      </td>
    </tr>
  </table>
  ...
  <table border="1" cellspacing="0" cellspacing="0" id="tbTableMain">
    ...
    foreach ($sociosAgrupados as $socio => $data) :
        if ($contadorSocios > 3) break; 
    ?>
        <tr style="background-color: #d9ead3; font-weight: bold;">
            <td style="text-align: center;"><?= $contadorSocios ?></td>
            <td><?= htmlspecialchars($socio) ?></td>
